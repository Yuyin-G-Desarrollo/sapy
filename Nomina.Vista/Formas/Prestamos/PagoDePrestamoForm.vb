...
Public Class PagoDePrestamoForm
    ...
    Public Sub AgregarFilaDePrestamosAutorizados(ByVal Prestamos As Entidades.SolicitudPrestamo)
        ...
        If cmbEstatus.SelectedItem.Equals("ENTREGADO AL COLABORADOR") Then
            ...
            If estatus.Equals("F") Then
                ...
                For Each row As DataGridViewRow In grdPrestamos.Rows
                    grdPrestamos.CurrentRow.Cells("clmEntregado").ReadOnly = True
        ...
        If cmbEstatus.SelectedItem.Equals("PENDIENTES POR RECIBIR") Then
    ...
    Private Sub btnenviar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnenviar.Click
        ...
        If contadorFilas > 0 Then
            ...
            mensajeExito.mensaje = "¿Estas seguro de querer realizar el pago de los préstamos? "
        ...
        Try
            ...
            If cmbEstatus.SelectedItem.Equals("RECIBIDOS") Then
                ...
                For Each row As DataGridViewRow In grdPrestamos.Rows 'Recorro todo el grid fila por fila
                    ...
                    recibido = row.Cells("clmEntregado").Value
