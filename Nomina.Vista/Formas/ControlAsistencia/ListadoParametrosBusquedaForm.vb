...
Public Class ListadoParametrosBusquedaForm
    ...
    Private Sub gridListadoParametrosDiseno(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        grid.DisplayLayout.Bands(0).Columns(3).FilterOperandStyle = FilterOperandStyle.Combo
        grid.DisplayLayout.Bands(0).Columns(4).FilterOperandStyle = FilterOperandStyle.Combo
