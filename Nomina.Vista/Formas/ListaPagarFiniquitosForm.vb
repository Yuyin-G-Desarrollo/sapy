...
Public Class ListaPagarFiniquitosForm
    ...
    Private Sub ListaPagarFiniquitosForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        WindowState = FormWindowState.Maximized
        Me.Panel4.BackColor = System.Drawing.ColorTranslator.FromHtml("#96CF3A")
        Me.Panel5.BackColor = System.Drawing.ColorTranslator.FromHtml("#FFBF96")
        Me.Panel6.BackColor = System.Drawing.ColorTranslator.FromHtml("#C5C5C5")
        ...
        grdFiltroSolicitudes.Columns.Add("DiasTrabajados", "Días Trabajados") '10
    ...
    Public Sub AgregarFila(ByVal ListaFiniquitos As Entidades.Finiquitos)
        ...
        If ListaFiniquitos.PEstado = "D" Then
        ...
        Try
            ...
            If e.RowIndex >= 0 Then
                If (CStr(grdFiltroSolicitudes.Rows(e.RowIndex).Cells("Estado").Value) <> "") Then
                    ...
                    If grdFiltroSolicitudes.CurrentRow.Cells(0).Value = True Then
                        grdFiltroSolicitudes.CurrentRow.Cells(0).Value = False
                    Else
                        grdFiltroSolicitudes.CurrentRow.Cells(0).Value = True
                    End If
                ...
                If FormadePago = "CHEQUE" Then
                    ...
                    For Each row As DataGridViewRow In grdFiltroSolicitudes.Rows 'Recorro todo el grid fila por fila
                        ...
                        If valorCheck <> 0 Then
                            ...
                            IDSolicitud = ObjCajas.EnviarSolicitudesCaja(IDCajas, FormadePago, CDbl(grdFiltroSolicitudes.Rows(sentinela).Cells("TotalEntregar").Value), CStr(grdFiltroSolicitudes.Rows(sentinela).Cells("Nombre").Value), "SOLICITUD DE CHEQUE PARA PAGO DE FINIQUITO")
                            objBUFiniquito.PagarSolicitudFiniquito(seleccion, CInt(IDSolicitud.Rows(0).Item(0)))
                            CountAcept += 1
                        End If
                        sentinela += 1
                    Next
                ...
                Else
                    ...
                    For Each row As DataGridViewRow In grdFiltroSolicitudes.Rows 'Recorro todo el grid fila por fila
                        ...
                        If valorCheck <> 0 Then
                            ...
                            objBUFiniquito.PagarSolicitudFiniquito(seleccion, 0)
                            Suma += CDbl(grdFiltroSolicitudes.Rows(sentinela).Cells("TotalEntregar").Value)
                    ...
                    For Each row As DataGridViewRow In grdFiltroSolicitudes.Rows 'Recorro todo el grid fila por fila
                        ...
                        If valorCheck <> 0 Then
                            ...
                            objBUFiniquito.PagarSolicitudFiniquito(seleccion, CInt(IDSolicitud.Rows(0).Item(0).ToString))
    ...
    Private Sub grdFiltroSolicitudes_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdFiltroSolicitudes.CellContentClick
