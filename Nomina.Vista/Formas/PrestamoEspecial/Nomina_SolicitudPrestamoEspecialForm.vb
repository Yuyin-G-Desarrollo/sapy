...
Public Class Nomina_SolicitudPrestamoEspecialForm
    ...
    Dim PrestamoEspecial As Integer = 1
    Dim CalculoInteres As Integer = 0


    Private Sub Nomina_SolicitudPrestamoEspecialForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Top = 0
        Me.Left = 0
        picBoxColaborador.Image = CType(My.Resources.ResourceManager.GetObject("YUMPER1"), Image)
        'Tools.FormatoCtrls.formato(Me)
        rbtnNoPagos.Checked = True
        ...
        'rbtnSemanal.Checked = True

        rbtnAbono.Enabled = False
        rbtnNoPagos.Enabled = False
        txtMonto.Enabled = False
        txtNoPagos.Enabled = False
    ...
    Public Sub AgregarDatos(ByVal ConfiguracionPrestamos As Entidades.ConfiguracionPrestamos)
        ...
        txtNoPagos.Text = ConfiguracionPrestamos.PSemanasMaximo.ToString
    ...
    Public Sub Calcular()
        ...
        Try
            ...
            End If
            ''
            If rbtnNoPagos.Checked = True Then
                If (Trim(txtMonto.Text.Length) < 1 Or txtNoPagos.Text = 0) Then
                    lblNoPagos.ForeColor = Color.Red
                    estaMal = True
                Else
                    lblNoPagos.ForeColor = Color.Black
                    estaMal = False
                End If
            End If
            ''
            ...
            Else
                ...
                Else
                    'CALCULAR EL INTERES SEMANAL O QUINCENAL
                    If rbtnSemanal.Checked = True Then
                        CalculoInteres = 7
                    ElseIf rbtnQuincenal.Checked = True Then
                        CalculoInteres = 15
                    End If
                    ...
                    If rbtnAbono.Checked = True Then
                        ...
                        Interes = CalculoInteres * (Interes / 30.4)
                        Interes = Interes / 100
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    If TipoInteres.Equals("INTERES FIJO") Or TipoInteres.Equals("INTERES SOBRE SALDO") Then
                                        ...
                                        Interes = CalculoInteres * (txtInteres.Text / 30.4)
                                        Interes = Interes / 100
                                        abono = txtAbono.Text
                                        numero = Monto / abono
                                        numero = -Int(-numero)
                    ...
                    If rbtnNoPagos.Checked = True Then
                        ...
                        If txtNoPagos.Text = 0 Or txtMonto.Text = 0 Then
    ...
    Public Sub guardar()
        ...
        Try
            ...
            ObjEnt.Psemanas = txtNoPagos.Text
            ...
            objBU.guardarPrestamosEspeciales(ObjEnt, PrestamoEspecial, CalculoInteres)
            btnGuardar.Enabled = False
            lblGuardar.Enabled = False
            btnCalcular.Enabled = False
            lblCalcular.Enabled = False
    ...
    Private Sub enviar_correo(ByVal naveID As Integer, ByVal clave As String)
        ...
        Email += "<td>" + txtNoPagos.Text.ToString + "</td>"
    ...
    Private Sub txtSemanas_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtNoPagos.KeyPress
        Dim caracter As Char = e.KeyChar
        If (caracter = ChrW(Keys.Back)) Then
            e.Handled = False
        Else
    ...
    Private Sub rbtnSemanas_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbtnNoPagos.CheckedChanged
        If rbtnNoPagos.Checked = True Then
            txtAbono.Text = ""
            txtAbono.Enabled = False
            txtNoPagos.Enabled = True
    ...
    Private Sub txtSemanas_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNoPagos.LostFocus
        If rbtnNoPagos.Checked = True Then
            Try
                txtNoPagos.Text = Format(CType(Me.txtNoPagos.Text, Decimal), "N0")
                lblNoPagos.ForeColor = Color.Black
    ...
    Private Sub cmbTipoInteres_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbTipoInteres.SelectedIndexChanged
        Dim TipoInteres As String = ""
        TipoInteres = cmbTipoInteres.SelectedItem.ToString

        If TipoInteres = "SIN INTERES" Then
            txtInteres.Text = 0
        Else
