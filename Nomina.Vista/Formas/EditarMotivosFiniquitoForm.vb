...
Public Class EditarMotivosFiniquitoForm
    ...
    Private Sub EditarMotivosFiniquito_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        initCombos()
        Dim objMotivoBU As New MotivosFiniquitoBU
    ...
    Private Sub btnGuardar_Click(sender As System.Object, e As System.EventArgs) Handles btnGuardar.Click
        ...
        Else
            ...
            If cmbNave.SelectedIndex > 0 Then
                ...
                Motivo.PNaveId = Nave
            End If
            Motivo.PMotivoFiniquitoId = idMOTIVO
            Dim objMotivosBU As New MotivosFiniquitoBU
            objMotivosBU.EdiarMotivosFiniquitos(Motivo)
            Me.Close()
