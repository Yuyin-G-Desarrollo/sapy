...
Public Class CartaUtilidades
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.CartaUtilidades.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCartaUtilidades
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CartaUtilidades = New CartaUtilidades()
        rpt.Site = Me.Site
        Return rpt
    End Function
