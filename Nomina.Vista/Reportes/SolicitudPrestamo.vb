...
Public Class SolicitudPrestamo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.SolicitudPrestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdPrestamo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSolicitudPrestamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SolicitudPrestamo = New SolicitudPrestamo()
        rpt.Site = Me.Site
        Return rpt
    End Function
