...
Public Class ReportesFiniquitos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.ReportesFiniquitos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_LogotipoNave() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportesFiniquitos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportesFiniquitos = New ReportesFiniquitos()
        rpt.Site = Me.Site
        Return rpt
    End Function
