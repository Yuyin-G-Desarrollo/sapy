...
Public Class credenciales_jeans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.credenciales_jeans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcredenciales_jeans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As credenciales_jeans = New credenciales_jeans()
        rpt.Site = Me.Site
        Return rpt
    End Function
