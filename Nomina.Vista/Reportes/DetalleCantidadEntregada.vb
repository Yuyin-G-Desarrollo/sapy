...
Public Class DetalleCantidadEntregada
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DetalleCantidadEntregada.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.DetalleCantidadEntregada.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fini_finiquitoid() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDetalleCantidadEntregada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DetalleCantidadEntregada = New DetalleCantidadEntregada()
        rpt.Site = Me.Site
        Return rpt
    End Function
