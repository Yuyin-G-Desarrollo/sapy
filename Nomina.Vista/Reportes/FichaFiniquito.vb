...
Public Class FichaFiniquito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.FichaFiniquito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFichaFiniquito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FichaFiniquito = New FichaFiniquito()
        rpt.Site = Me.Site
        Return rpt
    End Function
