...
Public Class ReporteIncentivos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.ReporteIncentivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteIncentivos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteIncentivos = New ReporteIncentivos()
        rpt.Site = Me.Site
        Return rpt
    End Function
