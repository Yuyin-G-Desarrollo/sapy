...
Public Class ReporteCierreSemanal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteCierreSemanal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.ReporteCierreSemanal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdCajaAhorro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteCierreSemanal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCierreSemanal = New ReporteCierreSemanal()
        rpt.Site = Me.Site
        Return rpt
    End Function
