...
Public Class credenciales_jeans2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "credenciales_jeans2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nomina.Vista.credenciales_jeans2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_colaboradorid() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcredenciales_jeans2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As credenciales_jeans2 = New credenciales_jeans2()
        rpt.Site = Me.Site
        Return rpt
    End Function
