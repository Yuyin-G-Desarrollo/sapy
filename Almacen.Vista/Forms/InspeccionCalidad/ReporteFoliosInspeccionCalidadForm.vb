...
Public Class ReporteFoliosInspeccionCalidadForm
    ...
    Dim EsAlmacen_2 As Boolean = False
    ...
    Private Sub ReporteFoliosInspeccionCalidadForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            cboCedis = Utilerias.ComboObtenerCEDISUsuario(cboCedis)
    ...
    Private Sub ObtenerInformacion()
        ...
        Try
            ...
            DtInformacion = OBJBU.ReporteDeInspeccion(FiltroNave, chkFechaInspeccion.Checked, dtpFechaInicio.Value, dtpFechaFin.Value, FiltroStatus, FiltroFoliosInspeccion, FiltrofolioSalida, EsAlmacen_2, cboCedis.SelectedValue)

            grdInspeccion.DataSource = DtInformacion
            DiseñoGrid.DiseñoBaseGrid(viewInspeccion)
            viewInspeccion.IndicatorWidth = 30
            viewInspeccion.OptionsView.ColumnAutoWidth = False

            viewInspeccion.Columns.ColumnByFieldName("ParesFolio").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
            viewInspeccion.Columns.ColumnByFieldName("ParesInspeccionados").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
            viewInspeccion.Columns.ColumnByFieldName("ParesDevueltos").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
            viewInspeccion.Columns.ColumnByFieldName("ParesIngresados").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
            viewInspeccion.Columns.ColumnByFieldName(" ").OptionsColumn.AllowEdit = True
            ...
            DiseñoGrid.EstiloColumna(viewInspeccion, "ParesFolio", "Pares Folio", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Like, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
            DiseñoGrid.EstiloColumna(viewInspeccion, "LotesPiloto", "Lotes Piloto", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Like, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
            DiseñoGrid.EstiloColumna(viewInspeccion, "ParesInspeccionados", "Pares Inspeccionados", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Like, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
            DiseñoGrid.EstiloColumna(viewInspeccion, "Incidencias", "Incidencias", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
            DiseñoGrid.EstiloColumna(viewInspeccion, "IncidenciasMayores", "Incidencias Menores", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
            DiseñoGrid.EstiloColumna(viewInspeccion, "IncidenciasCriticas", "Incidencias Mayores", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
            DiseñoGrid.EstiloColumna(viewInspeccion, "ParesDevueltos", "Pares Devueltos", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Like, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
            DiseñoGrid.EstiloColumna(viewInspeccion, "ParesIngresados", "Pares Ingresados", True, DevExpress.XtraGrid.Columns.AutoFilterCondition.Like, False, True, 60, True, DevExpress.Data.SummaryItemType.Sum, "{0:N0}")
    ...
    Private Sub btnDetalles_Click(sender As Object, e As EventArgs) Handles btnDetalles.Click
        ...
        Dim FoliosInspeccionId As String = ""
        ...
        Dim foliosSeleccionados As Integer = 0

        Try
            Cursor = Cursors.WaitCursor
            Dim numFilas As Integer = viewInspeccion.DataRowCount
            Dim filasSeleccionadas As String = ""

            For index As Integer = 0 To numFilas Step 1
                If CBool(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), " ")) = True Then
                    If FoliosInspeccionId.Length > 0 Then
                        FoliosInspeccionId += ","
                    End If
                    FoliosInspeccionId += viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "FolioInspeccionID").ToString()
                    ParesFolio += CInt(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "ParesFolio").ToString())
                    ParesIncidencias += CInt(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "Incidencias").ToString())
                    ParesDevueltos += CInt(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "ParesDevueltos").ToString())
                    'Nave = viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(Fila), "Nave").ToString()
                    ParesInspeccionados += CInt(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "ParesInspeccionados").ToString())
                    foliosSeleccionados += 1
                End If
            Next

            If FoliosInspeccionId.Length > 0 Then
                DetFolio.FoliosInspeccionId = FoliosInspeccionId
                ...
                DetFolio.numFolios = foliosSeleccionados
    ...
    Private Sub viewInspeccion_RowClick(sender As Object, e As RowClickEventArgs) Handles viewInspeccion.RowClick
        ...
        If e.Clicks = 2 Then
            ...
            Try
                ...
                If viewInspeccion.GroupCount > 0 Then
                    If viewInspeccion.IsGroupRow(e.RowHandle) = False Then
                        FolioInspeccionId = viewInspeccion.GetGroupRowValue(e.RowHandle, viewInspeccion.Columns.Where(Function(x) x.FieldName = "FolioInspeccionID").FirstOrDefault()).ToString()
                        ParesFolio = viewInspeccion.GetGroupRowValue(e.RowHandle, viewInspeccion.Columns.Where(Function(x) x.FieldName = "ParesFolio").FirstOrDefault()).ToString()
                        ParesIncidencias = viewInspeccion.GetGroupRowValue(e.RowHandle, viewInspeccion.Columns.Where(Function(x) x.FieldName = "Incidencias").FirstOrDefault()).ToString()
                        ParesDevueltos = viewInspeccion.GetGroupRowValue(e.RowHandle, viewInspeccion.Columns.Where(Function(x) x.FieldName = "ParesDevueltos").FirstOrDefault()).ToString()
                        Nave = viewInspeccion.GetGroupRowValue(e.RowHandle, viewInspeccion.Columns.Where(Function(x) x.FieldName = "Nave").FirstOrDefault()).ToString()
                        ParesInspeccionados = viewInspeccion.GetGroupRowValue(e.RowHandle, viewInspeccion.Columns.Where(Function(x) x.FieldName = "ParesInspeccionados").FirstOrDefault()).ToString()



                        ''FolioInspeccionId = viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(3), "FolioInspeccionID").ToString()
                        'ParesFolio = viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(e.RowHandle + 1), "ParesFolio").ToString()
                        'ParesIncidencias = viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(e.RowHandle + 1), "Incidencias").ToString()
                        'ParesDevueltos = viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(e.RowHandle + 1), "ParesDevueltos").ToString()
                        'Nave = viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(e.RowHandle + 1), "Nave").ToString()
                        'ParesInspeccionados = viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(e.RowHandle + 1), "ParesInspeccionados").ToString()
                        ...
                        If FolioInspeccionId > 0 Then
                            DetFolio.FoliosInspeccionId = FolioInspeccionId
                            DetFolio.ParesFolio = ParesFolio
                            DetFolio.ParesInspeccionados = ParesInspeccionados
                            DetFolio.Nave = Nave
                            DetFolio.ParesIncidencias = ParesIncidencias
    ...
    Public Sub CalculoGlobal()
        Dim PorcentajeInspeccionado As String = String.Empty
        Dim ParesInspeccionados As Integer = 0
        Dim ParesRecibidos As Integer = 0
        Dim NumeroFilas As Integer = 0
        Dim TotalParesInspeccionados As Integer = 0
        Dim TotalParesRecibidos As Integer = 0
        Dim Porcentaje As Double = 0

        Try

            Cursor = Cursors.WaitCursor
            NumeroFilas = viewInspeccion.DataRowCount

            For index As Integer = 0 To NumeroFilas Step 1

                ParesRecibidos = CInt(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "ParesFolio"))
                ParesInspeccionados = CInt(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "ParesInspeccionados"))

                If ParesRecibidos = 0 Then
                    ParesRecibidos = CInt(viewInspeccion.GetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), "ParesInspeccionados"))
                End If

                TotalParesInspeccionados += ParesInspeccionados
                TotalParesRecibidos += ParesRecibidos

            Next

            If TotalParesRecibidos = 0 Then
                lblPorcentajeInspeccionado.Text = "0%"
                lblParesInspeccionados.Text = CDbl(TotalParesInspeccionados).ToString("N0")
                lblParesRecibidos.Text = "0"
            Else
                Porcentaje = CDbl(TotalParesInspeccionados) / CDbl(TotalParesRecibidos) * 100.0
                PorcentajeInspeccionado = Math.Round(Porcentaje, 1).ToString() + "%"

                lblPorcentajeInspeccionado.Text = PorcentajeInspeccionado
                lblParesInspeccionados.Text = CDbl(TotalParesInspeccionados).ToString("N0")
                lblParesRecibidos.Text = CDbl(TotalParesRecibidos).ToString("N0")
    ...
    Private Sub chkSeleccionarTodo_CheckedChanged(sender As Object, e As EventArgs) Handles chkSeleccionarTodo.CheckedChanged
        Dim NumeroFilas = viewInspeccion.DataRowCount
        If NumeroFilas = 0 Then Return

        If chkSeleccionarTodo.Checked = True Then
            'Dim seleccionados As Int16 = 0
            For index As Integer = 0 To NumeroFilas Step 1
                viewInspeccion.SetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), " ", True)
            Next
        Else
            'Dim seleccionados As Int16 = 0
            For index As Integer = 0 To NumeroFilas Step 1
                viewInspeccion.SetRowCellValue(viewInspeccion.GetVisibleRowHandle(index), " ", False)
            Next
        End If
    End Sub
End Class