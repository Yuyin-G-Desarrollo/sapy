...
Public Class ListadoParametrosForm
                                                        ...
                                                        Else
                                                            ...
                                                            Else
                                                                ...
                                                                Else
                                                                    ...
                                                                    Else
                                                                        If tipo_busqueda = 17 Then
                                                                            lblTitulo.Text = "Status Folio Inspección"
                                                                            Me.Size = New System.Drawing.Size(575, 506)
                                                                        Else
                                                                            If tipo_busqueda = 18 Then 'Nave SICY
                                                                                lblTitulo.Text = "Nave"
                                                                                Me.Size = New System.Drawing.Size(575, 506)
                                                                            Else
                                                                                If tipo_busqueda = 20 Then
                                                                                    lblTitulo.Text = "Estatus Devolución"
                                                                                    Me.Size = New System.Drawing.Size(575, 506)
                                                                                End If
                                                                            End If
                                                                        End If
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        If tipo_busqueda <> 16 Then
            ...
            Tabla_ListadoParametros = objBU.ListadoParametroProyeccionEntregas(tipo_busqueda)

        Else

            ' Tabla_ListadoParametros = objBUPagos.consultaFiltroRFCCliente(ClientesID)
