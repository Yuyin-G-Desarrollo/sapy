...
Public Class ReporteFoliosInspeccionCalidadCOPPELForm
    ...
    Private Sub ReporteFoliosInspeccionCalidadCOPPELForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
    ...
    Private Sub PermisosPerfil()
        ...
        Try
            ...
            If Framework.Negocios.PermisosUsuarioBU.ConsultarPermiso("Calidad_Inpeccion_coppel", "ALMACEN_NAVE_Z") Then
                EsAlmacen_2 = True
            Else
                EsAlmacen_2 = False
            End If
