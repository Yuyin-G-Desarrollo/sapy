...
Public Class SalidaNaveLotesFormV3
        ...
        Try
            ...
            For Each Fila As DataRow In dtAtadosALeer.Rows
                ...
                With EntAtadoAux
                    ...
                    .PEtiquetaEspecial = Convert.ToInt32(Fila.Item("EtiquetaEspecial"))
                    .PCartaInformativa = Convert.ToInt32(Fila.Item("CartaInformativa"))
                End With
            ...
            For Each Fila As DataRow In dtParesALeer.Rows
                ...
                If Fila.Item("ResultadoParSalida").ToString = "1" Then
                    With EntPArAux
                        ...
                        .EtiquetaEspecial = Convert.ToInt32(Fila.Item("EtiquetaEspecial"))
                        .CartaInformativa = Convert.ToInt32(Fila.Item("CartaInformativa"))
                    End With
            ...
            Else
                If dtAtadosALeer.AsEnumerable().Where(Function(x) x.Item("Atado").ToString.Trim() = CodigoLeido).Count = 1 Then
                    ...
                    With DatosAtadoAux
                        ...
                        .PEtiquetaEspecial = Convert.ToInt32(Atado.Item("EtiquetaEspecial"))
                        .PCartaInformativa = Convert.ToInt32(Atado.Item("CartaInformativa"))
                    End With
                Else
                    DatosAtadoAux = ObjBU.ValidarAtado(CodigoLeido)
                End If
        ...
        Try
            ...
            If dtParesALeer.AsEnumerable.Where(Function(x) x.Item("Atado") = DatosAtado.PIdAtado And x.Item("CodigoPorLeer").ToString.TrimStart("0") = CodigoPorLeer).Count >= 1 And DatosAtado.PLecturaPorCodigoCliente = True Then
                ...
                With EntPar
                    ...
                    .EtiquetaEspecial = Convert.ToInt32(Par.Item("EtiquetaEspecial"))
                    .CartaInformativa = Convert.ToInt32(Par.Item("CartaInformativa"))
                End With
    ...
    Private Sub DiseñoGridAtadosPendientes(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Try
            ...
            grid.DisplayLayout.Bands(0).Columns("PEtiquetaEspecial").CellAppearance.TextHAlign = HAlign.Right
            grid.DisplayLayout.Bands(0).Columns("PCartaInformativa").CellAppearance.TextHAlign = HAlign.Right
            ...
            grid.DisplayLayout.Bands(0).Columns("PEtiquetaEspecial").Header.Caption = "EE"
            grid.DisplayLayout.Bands(0).Columns("PCartaInformativa").Header.Caption = "CI"
            grid.DisplayLayout.Bands(0).Columns("PCartaInformativa").Width = 20
            grid.DisplayLayout.Bands(0).Columns("PEtiquetaEspecial").Width = 20
            ...
            grid.DisplayLayout.Bands(0).Columns("PEtiquetaEspecial").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
            grid.DisplayLayout.Bands(0).Columns("PCartaInformativa").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
    ...
    Private Sub DiseñoGridLecturaPares(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Try
            ...
            grid.DisplayLayout.Bands(0).Columns("CodigoPorLeer").CellAppearance.TextHAlign = HAlign.Right
            grid.DisplayLayout.Bands(0).Columns("EtiquetaEspecial").CellAppearance.TextHAlign = HAlign.Right
            grid.DisplayLayout.Bands(0).Columns("CartaInformativa").CellAppearance.TextHAlign = HAlign.Right
            ...
            grid.DisplayLayout.Bands(0).Columns("EtiquetaEspecial").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
            grid.DisplayLayout.Bands(0).Columns("CartaInformativa").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
            grid.DisplayLayout.Bands(0).Columns("DescripcionCompleta").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit

            grid.DisplayLayout.Bands(0).Columns("EtiquetaEspecial").Header.Caption = "EE"
            grid.DisplayLayout.Bands(0).Columns("CartaInformativa").Header.Caption = "CI"

            grid.DisplayLayout.Bands(0).Columns("EtiquetaEspecial").Width = 20
            grid.DisplayLayout.Bands(0).Columns("CartaInformativa").Width = 20
    ...
    Private Sub ReporteSalida(ByVal FolioSalidaID As Integer, ByVal NaveId As Integer)
        ...
        With dtParesAEmbarcar
            ...
            .Columns.Add("EtiquetaEspecial", GetType(Boolean))
            .Columns.Add("CartaInformativa", GetType(Boolean))
        End With
        ...
        For Each Fila As DataRow In dtLoteAux.Rows
            dtParesAEmbarcar.Rows.Add(Fila.Item("LOTE"), Fila.Item("CLIENTE"), Fila.Item("AÑO"), Fila.Item("ATADOS"), Fila.Item("PARES"), Fila.Item("ModeloSAY"), Fila.Item("DESCRIPCION"), Fila.Item("CORRIDA"), CDate(Fila.Item("Programa")).ToShortDateString(), Fila.Item("EtiquetaEspecial"), Fila.Item("CartaInformativa"))
        ...
        EntidadReporte = OBJBUReporte.LeerReporteporClave("REPORTE_SALIDASNAVE_LOTESPILOTO_V2")
    ...
    Private Sub grdIncorrecto_InitializeRow(sender As Object, e As InitializeRowEventArgs) Handles grdIncorrecto.InitializeRow
        ...
        If e.Row.Cells("PEtiquetaEspecial").Value = 1 Then
            e.Row.Cells("PEtiquetaEspecial").Appearance.BackColor = lblEtiquetaEspecial.BackColor
            e.Row.Cells("PEtiquetaEspecial").Appearance.ForeColor = lblEtiquetaEspecial.BackColor
        Else
            e.Row.Cells("PEtiquetaEspecial").Appearance.ForeColor = Color.Transparent
        End If

        If e.Row.Cells("PCartaInformativa").Value = 1 Then
            e.Row.Cells("PCartaInformativa").Appearance.BackColor = lblCartaInformativa.BackColor
            e.Row.Cells("PCartaInformativa").Appearance.ForeColor = lblCartaInformativa.BackColor
        Else
            e.Row.Cells("PCartaInformativa").Appearance.ForeColor = Color.Transparent
        End If
    End Sub

    Private Sub grdLectura_InitializeRow(sender As Object, e As InitializeRowEventArgs) Handles grdLectura.InitializeRow
        If e.Row.Cells("EtiquetaEspecial").Value = 1 Then
            e.Row.Cells("EtiquetaEspecial").Appearance.BackColor = lblEtiquetaEspecial.BackColor
            e.Row.Cells("EtiquetaEspecial").Appearance.ForeColor = lblEtiquetaEspecial.BackColor
        Else
            e.Row.Cells("EtiquetaEspecial").Appearance.ForeColor = Color.Transparent
        End If

        If e.Row.Cells("CartaInformativa").Value = 1 Then
            e.Row.Cells("CartaInformativa").Appearance.BackColor = lblCartaInformativa.BackColor
            e.Row.Cells("CartaInformativa").Appearance.ForeColor = lblCartaInformativa.BackColor
        Else
            e.Row.Cells("CartaInformativa").Appearance.ForeColor = Color.Transparent
        End If
    End Sub
End Class