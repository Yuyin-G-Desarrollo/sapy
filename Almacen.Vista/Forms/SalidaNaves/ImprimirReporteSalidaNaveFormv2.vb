...
Imports Tools
Public Class ImprimirReporteSalidaNaveFormv2
    ...
    Private Sub ImprimirReporteSalidaNaveFormv2_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Public Sub Recuperar_Salidas_De_Nave(ByVal Fecha_Inicio As String, ByVal Fecha_Fin As String, ByVal IdNave As Integer)
        ...
        dtSalidaNave = objBU.ObtenerListaLotesReporteSalida(IdNave, Fecha_Inicio, Fecha_Fin)
