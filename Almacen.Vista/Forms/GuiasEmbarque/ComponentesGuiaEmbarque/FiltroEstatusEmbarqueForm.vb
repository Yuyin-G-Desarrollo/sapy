...
Public Class FiltroEstatusEmbarqueForm
    ...
    Private Sub FiltroEstatusEmbarqueForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub poblar_gridListadoParametros()
        ...
        Tabla_ListadoParametros = objBU.consultarEstatusEmbarque(0)
