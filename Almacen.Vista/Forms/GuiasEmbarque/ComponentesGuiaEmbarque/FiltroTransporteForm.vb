...
Public Class FiltroTransporteForm
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Tabla_ListadoParametros = objBU.ConsultarMensjaeriaFiltro()
    ...
    Private Sub FiltroTransporteForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
