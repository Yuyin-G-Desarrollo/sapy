...
Public Class ListaInventariosCiclicosForm
    ...
    Dim Par_Atado As String = String.Empty
    ...
    Private Sub ListaInventariosCiclicosForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Framework.Negocios.PermisosUsuarioBU.ConsultarPermiso("ALM_CALIDAD_INVENTARIOCICLICO", "VER_BOTON_CICLICO") Then
            pnlAltasEditar.Visible = True
        Else
            pnlAltasEditar.Visible = False
        End If
    ...
    Public Sub LlenarListaInventarios()
        ...
        With BusquedaInventario
            ...
            .PCliente = IdClientes
            .PTienda = IdTiendas
            If IdPedidos <> String.Empty Then
                IdPedidos = "'" + IdPedidos.Replace(",", "','") + "'"
            End If
            .PPedido = IdPedidos
            .PEstado = IdEstados
...
#Region "Funcionalidad Grid"
    ...
    Private Sub grdInventariosCiclicos_InitializeLayout(sender As Object, e As InitializeLayoutEventArgs) Handles grdInventariosCiclicos.InitializeLayout
        With grdInventariosCiclicos
            ...
            .DisplayLayout.Bands(0).Columns("IdInventarioCiclico").CellAppearance.TextHAlign = HAlign.Right
            .DisplayLayout.Bands(0).Columns("IdInventarioCiclico").Header.Caption = "No."
            .DisplayLayout.Bands(0).Columns("Id Operador").Hidden = True
            .DisplayLayout.Bands(0).Columns("EstadoID").Hidden = True
            ...
            .DisplayLayout.Bands(0).Columns("Pares").Width = 70
            .DisplayLayout.Bands(0).Columns("Faltantes").Width = 70
            .DisplayLayout.Bands(0).Columns("Sobrantes").Width = 70
            .DisplayLayout.Bands(0).Columns("Fecha Programada").Width = 100
            .DisplayLayout.Bands(0).Columns("Fecha de Ejecución").Width = 100
            .DisplayLayout.Bands(0).Columns("Fecha Programada").Style = ColumnStyle.DateTime
            ...
            .DisplayLayout.Bands(0).Columns("Operador").Width = 170
            .DisplayLayout.Bands(0).Columns("Descripción").Width = 200
            .DisplayLayout.Bands(0).Columns("Tipo_Escaneo").Header.Caption = "Tipo de Escaneo"
    ...
    Private Sub grdInventariosCiclicos_ClickCell(sender As Object, e As ClickCellEventArgs) Handles grdInventariosCiclicos.ClickCell
        ...
        End If
        IdEstado = CInt(row.Cells("EstadoID").Text)
        ...
        End If
        Par_Atado = row.Cells("Tipo_Escaneo").Text
    End Sub
    ...
    Private Sub grdInventariosCiclicos_DoubleClickCell(sender As Object, e As DoubleClickCellEventArgs) Handles grdInventariosCiclicos.DoubleClickCell
        ...
        mensajeAdvertencia.mensaje = "Este proceso puede tardar dependiendo de los pares a cargar"
        mensajeAdvertencia.ShowDialog()
        ...
        Fecha = CDate(row.Cells("Fecha Programada").Text)
        IdEstado = CInt(row.Cells("EstadoID").Text)
        Par_Atado = CStr(row.Cells("Tipo_Escaneo").Value)
...
#End Region
    ...
    Private Sub tsmReporteInventario_Click(sender As Object, e As EventArgs) Handles tsmReporteInventario.Click
        ...
        ElseIf IdEstado = 3 Then
            Dim Forma As New ConsultaResultadosInventarioCiclico
            Forma.StartPosition = FormStartPosition.CenterScreen
            Forma.idnave = idnave
            Forma.NombreOperador = NombreOperador
            Forma.lblObservaciones.Visible = True
            Forma.txtObservaciones.Visible = True
            Forma.ShowDialog()
            Observaciones = Forma.txtObservaciones.Text
    ...
    Public Sub ImprimirResultadoInventario()
        ...
        reporte("Usuario") = Entidades.SesionUsuario.UsuarioSesion.PUserUsername.ToString
        reporte("Operador") = NombreOperador
        Dim fechaimp As String = DateTime.Parse(FechaReal).ToString("dd/MM/yyyy HH:mm:ss")
        reporte("Fecha") = fechaimp
    ...
    Private Sub tsmReporteInventarios_Click(sender As Object, e As EventArgs) Handles tsmReporteInventarios.Click
        ...
        Forma.NombreOperador = NombreOperador
        Forma.ShowDialog()
        fechaInicio = Forma.fechaInicio
        fechaFin = Forma.fechaFin
    ...
    Public Sub IniciarInventarioCiclico()
        ...
        If objBU.VerificarInventariosEnProcesoUsuarioLoggueado() = False Then
            ...
            Try
                ...
                show_message("Exito", "El inventario inició correctamente.")
            Catch ex As Exception
                MsgBox(ex.ToString)
            End Try
    ...
    Public Sub Imprimir_ReporteIndicadoresDeInventatiosCiclicos(ByVal dsResumenInventarios As DataSet)
        ...
        reporte("urlImagenNave") = Tools.Controles.ObtenerLogoNave(idnave)
        reporte("nombreNave") = "Comercializadora"
        reporte("FechaInicio") = fechaInicio.Substring(0, 10)
        reporte("FechaFin") = fechaFin.Substring(0, 10)
        reporte.Dictionary.Clear()
