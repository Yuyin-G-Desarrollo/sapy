...
Public Class ListadoParametroUbicacionForm
                                    ...
                                    Else
                                        ...
                                        Else
                                            ...
                                            Else
                                                If tipo_busqueda = 11 Then
                                                    grid.DisplayLayout.AutoFitStyle = AutoFitStyle.ResizeAllColumns
                                                    grid.DisplayLayout.Bands(0).Columns("Nombre").Width = 170
                                                    grid.DisplayLayout.Bands(0).Columns("Clasificación").Width = 50
                                                    grid.DisplayLayout.Bands(0).Columns("Bloqueado").Width = 50
                                                    grid.DisplayLayout.Bands(0).Columns("Ranking").Width = 50
                                                Else
                                                    If tipo_busqueda = 12 Then
                                                        grid.DisplayLayout.AutoFitStyle = AutoFitStyle.ResizeAllColumns
                                                    Else
