...
Public Class ListadoParametroSalidasForm

    Public tipo_busqueda As Integer
    Public listaParametroID As List(Of String)
    Public listParametros As New DataTable()

    Private Sub ListadoParametroSalidasForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If tipo_busqueda = 1 Then
            lblTitulo.Text = "Mensajerías (Reales)"
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Tabla_ListadoParametros = objBU.ListadoParametroSalidas(tipo_busqueda)
