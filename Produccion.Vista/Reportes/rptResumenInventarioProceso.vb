...
Public Class rptResumenInventarioProceso
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptResumenInventarioProceso.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Produccion.Vista.rptResumenInventarioProceso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenInventarioProceso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenInventarioProceso = New rptResumenInventarioProceso()
        rpt.Site = Me.Site
        Return rpt
    End Function
