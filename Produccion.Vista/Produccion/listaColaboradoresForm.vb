...
Public Class listaColaboradoresForm
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        If grdColaboradores.Rows.Count > 0 Then
            If grdColaboradores.ActiveRow.Selected = True Then
                guardarSeleccion()
            Else
                Dim mensaje As New AdvertenciaForm
                mensaje.mensaje = "Selecciona un colaborador."
                mensaje.ShowDialog()
            End If
    ...
    Public Sub LlenarListaColaboradores()
        ...
        tabla = obj.listaColaboradores(nave)
    ...
    Private Sub listaColaboradoresForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub grdColaboradores_ClickCell(sender As Object, e As ClickCellEventArgs) Handles grdColaboradores.ClickCell
        Try
            grdColaboradores.ActiveRow.Selected = True
        Catch ex As Exception
