...
Public Class OrdenesEnProceso_ListadoParametrosForm
    Public tipoBusqueda As Integer
    Public parametroFiltro As Integer = 0
    ...
    Private Sub OrdenesEnProceso_ListadoParametrosForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LlenarGridParametros()
    End Sub

    Private Sub LlenarGridParametros()
        ...
        Select Case tipoBusqueda
            Case 1
                titulo = "Nave Desarrollo"
            Case 2
                titulo = "Hormas"
            Case 3
                titulo = "Proveedor Suelas"
            Case 4
                titulo = "Temporadas"
            Case 5
                titulo = "Corridas"
            ...
            Case 10
                titulo = "Piel Color"
            Case 11
                titulo = "Familia Ventas"
            Case 12
                titulo = "Familia"
            Case Else
                titulo = "Filtro no reconocido"
        End Select
        lblTitulo.Text = titulo
        Tabla_ListadoParametros = objOrdenesEnProcesoBU.ConsultarParametrosFiltros(tipoBusqueda, parametroFiltro)
        gridListadoParametros.DataSource = Tabla_ListadoParametros
        gridListadoParametrosDiseno(gridListadoParametros)
