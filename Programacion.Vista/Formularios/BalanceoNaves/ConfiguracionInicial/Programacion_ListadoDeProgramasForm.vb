...
Public Class Programacion_ListadoDeProgramasForm
    ...
    Dim semana As Int32
    Dim anio As Int32
    Private Sub Programacion_ListadoDeProgramasForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Hola1
        LlenarCombo()
        LlenarSemanaAnio()
    End Sub
    ...
    Private Sub Guardar()
        'Se guardan al realizar los cambioo sde pares en el grid
        'Dim obj As New BalanceoNavesBU
    End Sub
