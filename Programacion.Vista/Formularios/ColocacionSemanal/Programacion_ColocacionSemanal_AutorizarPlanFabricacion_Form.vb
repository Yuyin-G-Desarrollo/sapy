...
Public Class Programacion_ColocacionSemanal_AutorizarPlanFabricacion_Form
    ...
    End Function
    Private Sub Programacion_ColocacionSemanal_AutorizarPlanFabricacion_Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        obj.AutorizarPlan(vXmlCeldasModificadas.ToString, año)
