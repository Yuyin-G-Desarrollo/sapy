...
Public Class ListadoParametros_MovimientosColecciones
    Public tipo_busqueda As Integer
    Public listParametros As New DataTable
    Public listaParametroID As List(Of String)
    Private Sub ListadoParametros_MovimientosColecciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        If tipo_busqueda = 2 Then
            lblTitulo.Text = "Tipo Movimiento"
        End If
        ...
        If tipo_busqueda = 16 Then
            lblTitulo.Text = "Clasificación"
        End If



        Tabla_ListadoParametros = objBU.ListadoParametroMovimientoColecciones(tipo_busqueda)
