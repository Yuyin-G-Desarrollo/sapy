...
Public Class FiltrosMovimientosArticulos
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        grid.DataSource = Nothing
            ...
            If tipo_busqueda = 1 Then
                ...
                Colecciones = 0
                Tabla_ListadoParametros = objBU.ListadoParametroMovimientoColeccionesfiltro(Tipo, tipo_busqueda, NaveSayId, Marca, Colecciones)
            End If
