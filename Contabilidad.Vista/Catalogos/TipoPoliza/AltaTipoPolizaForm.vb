...
Public Class AltaTipoPolizaForm

    Private Sub AltaTipoPolizaForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        tipoPoliza.polizatipoid = 0
        tipoPoliza.nombre = txtDescripcion.Text
        tipoPoliza.status = True
