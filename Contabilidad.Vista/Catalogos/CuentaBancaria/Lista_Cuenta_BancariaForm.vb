...
Public Class Lista_Cuenta_BancariaForm
    ...
    Private Sub gridListaCuentaBancariaDiseno(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        With grid.DisplayLayout
            ...
            .Bands(0).Columns("incluircotizaciones").Hidden = True
            .Bands(0).Columns("pagoremision").Hidden = True
            .Bands(0).Columns("pagofacturas").Hidden = True
            ...
            .Bands(0).Columns("mone_nombre").Header.Caption = "Moneda"
            .Bands(0).Columns("cuba_clabeinterbancaria").Header.Caption = "Clabe"
    ...
    Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        ...
        Else
            ...
            form.idRazonSocial = gridListaCuentaBancaria.ActiveRow.Cells("Empresa ID").Value.ToString
            form.numeroCuentaSicy = gridListaCuentaBancaria.ActiveRow.Cells("Cuenta SICY ID").Value.ToString
            form.idCuentaContpaq = gridListaCuentaBancaria.ActiveRow.Cells("Id Cuenta Contpaq").Value.ToString
            form.idBancoContpaq = gridListaCuentaBancaria.ActiveRow.Cells("Id Banco Contpaq").Value.ToString
            form.idBanco = gridListaCuentaBancaria.ActiveRow.Cells("Banco ID").Value.ToString
            form.idMoneda = gridListaCuentaBancaria.ActiveRow.Cells("cuba_monedaid").Value.ToString
            form.clabe = gridListaCuentaBancaria.ActiveRow.Cells("cuba_clabeinterbancaria").Value.ToString.Trim.ToUpper
            form.incluircotizaciones = CBool(gridListaCuentaBancaria.ActiveRow.Cells("incluircotizaciones").Value)
            form.pagoremision = CBool(gridListaCuentaBancaria.ActiveRow.Cells("pagoremision").Value)
            form.pagofacturas = CBool(gridListaCuentaBancaria.ActiveRow.Cells("pagofacturas").Value)
    ...
    Private Sub gridListaCuentaBancaria_DoubleClickCell(sender As Object, e As DoubleClickCellEventArgs) Handles gridListaCuentaBancaria.DoubleClickCell
