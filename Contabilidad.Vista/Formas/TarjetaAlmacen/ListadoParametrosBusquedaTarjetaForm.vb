...
Public Class ListadoParametrosBusquedaTarjetaForm
    ...
    Private Sub ListadoParametrosBusquedaTarjetaForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Try
            ...
            Tabla_ListadoParametros = objBU.ListadoParametrosReportes(tipo_busqueda, idUsuario, empresaId)
    ...
    Private Sub SeleccionarTipoFiltro()
        ...
        If rdbActivos.Checked Then
            For Each Fila As UltraGridRow In gridListadoParametros.Rows
                If Fila.Cells("Activo").Value = "NO" Then
                    Fila.Hidden = True
                Else
                    Fila.Hidden = False
                End If
        ...
        ElseIf rdbActivos.Checked = False And rdbInactivos.Checked = True Then
            For Each Fila As UltraGridRow In gridListadoParametros.Rows
                If Fila.Cells("Activo").Value = "SI" Then
                    Fila.Hidden = True
                Else
                    Fila.Hidden = False
                End If
