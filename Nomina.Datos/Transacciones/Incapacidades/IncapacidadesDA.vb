...
Public Class IncapacidadesDA
    Public Function ValidarIncapacidad(ByVal ColaboradorID As Integer, ByVal FechaInicio As DateTime, ByVal FechaFin As DateTime) As DataTable
    ...
    Public Sub EditarIncapacidades(ByVal ListaAltaIncapacidad As Entidades.Incapacidades)
        ...
        listaParametros.Add(parametro)
        parametro = New SqlParameter
        parametro.ParameterName = "inc_fechamodificacion"
        parametro.Value = ListaAltaIncapacidad.PFechaModificacion
        listaParametros.Add(parametro)
    ...
    Public Function actualizarExpediente(ByVal idColaborador As Int32, ByVal idIncapacidad As Int32, ByVal tituloMovimiento As String,
                                         ByVal carpeta As String, ByVal archivo As String) As DataTable
        Dim operacion As New Persistencia.OperacionesProcedimientos
        Dim listaParametros As New List(Of SqlParameter)
        Dim parametro As SqlParameter
