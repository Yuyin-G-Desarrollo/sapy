...
#Region "Contructores"
    ...
    Sub New()
        _hostname = My.Settings.FacftpURL
        _password = My.Settings.FacftpPassword
        _username = My.Settings.FacftpUser
...
#End Region
    ...
    Public Function obtenerURL() As String
        Return My.Settings.FacftpURL
    End Function

    Public Function obtenerUsuario() As String
        Return My.Settings.FacftpUser
    End Function

    Public Function obtenerContrasena() As String
        Return My.Settings.FacftpPassword
    End Function
