...
#End Region
    ...
    Public Function CargaSimulacionValidaLayout(ByVal archivo As DataTable, ByVal opcion As Integer) As String
        ...
        Return respuesta
    End Function
    Public Function ConsultarInformacionPeriodo(ByVal fechaInici As DateTime, ByVal fechaFin As DateTime, ByVal id As Integer) As DataTable
        Dim objDA As New Programacion.Datos.CargaSimulacionDA
        Dim dt As DataTable = Nothing
        Select Case id
            Case 1 'Horma
                dt = objDA.ConsultarCargaSimulacion(fechaInici, fechaFin)
            Case 3 'Suela
                dt = objDA.ConsultarSuelaCargaSimulacion(fechaInici, fechaFin)
        End Select
        Return dt
    End Function
...
#Region "Nave-Corrida-Coleccion"
    ...
    End Function
    Public Function ConsultaHomaNaveTallaBase() As String
        Dim objDA As New Programacion.Datos.CargaSimulacionDA
        Dim dtSuelaTalla As DataTable = Nothing
        Dim strDuplicados As String = ""
        dtSuelaTalla = objDA.ConsultaHomaNaveTallaBase()
        For Each rowDup As DataRow In dtSuelaTalla.Rows
            strDuplicados = strDuplicados & String.Format("Registro de Horma cargado anteriormente: Nave = {0}, Horma = {1}, Colección = {2}, Corrida = {3}, Talla = {4}, Pares = {5}, Semana = {6}, Año = {7}", rowDup("honata_nave"), rowDup("honata_horma"), rowDup("honata_coleccion"), rowDup("honata_corrida"), rowDup("honata_talla"), rowDup("honata_pares"), rowDup("hor_semana"), rowDup("hor_anio")) & vbNewLine
        Next
        Return strDuplicados
    End Function
    ...
    Public Function InsertarSuelaBaseSimulacion(ByVal fechaInicio As DateTime, ByVal fechaFin As DateTime) As DataTable
        Dim objDA As New Programacion.Datos.CargaSimulacionDA
        Return objDA.CargaSuelaSimulacionBase(fechaInicio, fechaFin)
        objDA = Nothing
    End Function
...
#Region "Suela-Talla"
    ...
    Public Function ConsultaDuplicadosSuelaTalla() As String
        Dim objDA As New Programacion.Datos.CargaSimulacionDA
        Dim dtSuelaTalla As DataTable = Nothing
        Dim strDuplicados As String = ""
        dtSuelaTalla = objDA.ConsultaSuelaTallaVal()
        For Each rowDup As DataRow In dtSuelaTalla.Rows
            strDuplicados = strDuplicados & String.Format("Registro Suela-Talla cargado anteriormente: Suela = {0}, Colección = {1}, Corrida = {2}, Talla = {3}, Pares = {4}, Semana = {5}, Año = {5}", rowDup("Suela"), rowDup("coleccion"), rowDup("corrida"), rowDup("talla"), rowDup("pares"), rowDup("semana"), rowDup("anio")) & vbNewLine
        Next
        Return strDuplicados
    End Function
#End Region
