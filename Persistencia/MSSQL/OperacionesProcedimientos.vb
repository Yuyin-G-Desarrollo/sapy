...
Public Class OperacionesProcedimientos
	...
	Public Function EjecutarConsultaSP(ByVal NombreSP As String, ByVal Parametros As List(Of SqlParameter)) As DataTable
		Try
            ...
            ComandoSql.CommandTimeout = 600000
    ...
    Public Function EjecutarConsultaSPDataSet(ByVal NombreSP As String, ByVal Parametros As List(Of SqlParameter)) As DataSet
        Try

            Dim StatusEjecucion As Int32 = 0
            Dim MensajeEjecucion As String = String.Empty
            Dim DtsSeleccion = New DataSet
            EjecutarConsultaSPDataSet = New DataSet
