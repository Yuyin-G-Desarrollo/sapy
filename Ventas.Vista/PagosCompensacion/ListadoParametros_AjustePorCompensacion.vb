...
Public Class ListadoParametros_AjustePorCompensacion

    Public tipo_busqueda As Integer
    Public listaParametroId As List(Of String)
    Public listaParametros As New DataTable
    Private Sub ListadoParametros_AjustePorCompensacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub poblarGrid(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        Dim objBU As New AdministrarComplementoPagoCompensacionBU
        Dim listadoTabla As New DataTable

        grid.DataSource = Nothing
        listadoTabla = objBU.obtenerClientes(tipo_busqueda)
