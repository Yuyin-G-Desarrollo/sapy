...
Public Class SeguimientoParesProyeccionForm
    ...
    Const EsModoConsulta As Boolean = False
    ...
    Public Sub CargarEnProceso()
        ...
        grdProduccion.DataSource = objBU.ConsultaParesEnProceso(SesionID)
    End Sub
    ...
    Public Sub CargarBloqueados()
        ...
        grdBloqueados.DataSource = objBU.ConsultaParesBloquedos(SesionID)
    End Sub
    ...
    Public Sub CargarReproceso()
       Dim objBU As New ProyeccionEntregasBU
        ...
        grdReproceso.DataSource = objBU.ConsultaParesEnReproceso(SesionID)
    End Sub

    Public Sub CargarClientesBloqueados()
        Dim objBU As New ProyeccionEntregasBU
        Dim ModoConsulta As Boolean = False
        grdClientesBloqueados.DataSource = Nothing
        DiseñoClientesBloqueados(grdClientesBloqueados)
        grdClientesBloqueados.DataSource = objBU.ConsultaClientesBloqueados(SesionID, ModoConsulta)
    End Sub
