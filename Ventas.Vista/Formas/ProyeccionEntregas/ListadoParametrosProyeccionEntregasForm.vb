...
Public Class ListadoParametrosProyeccionEntregasForm
    ...
    Public MarcarAgentes As Boolean = False
    ...
    Private Sub ListadoParametrosProyeccionEntregasForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If tipo_busqueda = 1 Then
            If tipoCliente = "I" Then
                lblTitulo.Text = "Clientes Internos"
                                                            ...
                                                            Else
                                                                ...
                                                                Else
                                                                    If tipo_busqueda = 16 Then
                                                                        If tipoCliente = "E" Then
                                                                            lblTitulo.Text = "RFC Receptor"
                                                                            Me.Size = New System.Drawing.Size(1050, 506)
                                                                        Else
                                                                            lblTitulo.Text = "RFC Receptor Interno"
                                                                            Me.Size = New System.Drawing.Size(1050, 506)
                                                                        End If
                                                                    Else
                                                                        If tipo_busqueda = 22 Then
                                                                            lblTitulo.Text = "Motivo"
                                                                            Me.Size = New System.Drawing.Size(575, 506)
                                                                        Else
                                                                            If tipo_busqueda = 23 Then
                                                                                lblTitulo.Text = "Status Cancelación"
                                                                                Me.Size = New System.Drawing.Size(575, 506)
                                                                            Else
                                                                                If tipo_busqueda = 24 Then
                                                                                    lblTitulo.Text = "RFC Receptor"
                                                                                    Me.Size = New System.Drawing.Size(575, 506)
                                                                                Else
                                                                                    If tipo_busqueda = 25 Then
                                                                                        lblTitulo.Text = "Colaboradores"
                                                                                        Me.Size = New System.Drawing.Size(575, 506)
                                                                                    End If
                                                                                End If
    ...
    Public Sub MarcarRegistrosTodos()

        If MarcarAgentes Then
            For Each row As UltraGridRow In gridListadoParametros.Rows
                row.Cells(" ").Value = True
            Next
        End If
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Dim objBUPagos As New Negocios.AdministradorComplementoRecepcionPagosBU
        Dim Tabla_ListadoParametros As New DataTable

        If tipo_busqueda <> 16 Then

            Tabla_ListadoParametros = objBU.ListadoParametroProyeccionEntregas(tipo_busqueda, Entidades.SesionUsuario.UsuarioSesion.PIDColaboradorUser, TipoPerfil, tipoCliente)

        Else
            Tabla_ListadoParametros = objBUPagos.consultaFiltroRFCCliente(ClientesID, tipoCliente)
        End If
