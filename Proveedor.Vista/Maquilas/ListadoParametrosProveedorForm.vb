...
Public Class ListadoParametrosProveedorForm
    Public tipo_busqueda As Integer
    Public listaParametroId As List(Of String)
    Public listaParametros As New DataTable


    Private Sub ListadoParametrosProveedorForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub poblar_gridListadoParametros(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Tabla_ListadoParametros = objBU.ListadoParametroProveedor(tipo_busqueda)
