...
Public Class ListadoProveedorSemanaPago
    Public tipo_busqueda As Integer
    Public listaParametroId As List(Of String)
    Public listaParametros As New DataTable

    Private Sub ListadoParametroProvededorForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub poblarGrid(grid As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        listadoTabla = objBU.obtenerProveedor(tipo_busqueda)
