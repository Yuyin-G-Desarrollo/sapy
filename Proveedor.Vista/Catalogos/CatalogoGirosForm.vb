...
Public Class CatalogoGirosForm

    Dim GiroID As Integer = -1
    Dim Giro As String = String.Empty


    Private Sub CatalogoGirosForm_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub CargarGirosClasificaciones()
        ...
        gridDiseno(grdGiros)
        grdGiros.DataSource = objBU.ConsultaGiros(rdoSi.Checked)
