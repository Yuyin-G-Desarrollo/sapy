...
Public Class AlertaDiasMigracionInfraestructuraForm
    Private Sub AlertaDiasMigracionInfraestructuraForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'obtenerImagen64Sql()
    End Sub
    ...
    '    dtImagen64 = objAlerta.obtenerAlertaMigracion(2)
    '    If dtImagen64.Rows.Count > 0 Then
    '        imagen = dtImagen64.Rows(0).Item(0).ToString
    '        pbAvisoDiasRestantes.SizeMode = PictureBoxSizeMode.Zoom
    '        pbAvisoDiasRestantes.Image = ConvertBase64ToImage(imagen)
    '    End If
    'End Sub
