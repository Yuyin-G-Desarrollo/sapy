Public Class ConfiguracionColoresForm
	...
	Private Sub ConfiguracionColoresForm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        'grdColores.BackgroundColor = System.Drawing.ColorTranslator.FromHtml(My.Settings.grid)
		lblTitulo.ForeColor = System.Drawing.ColorTranslator.FromHtml(My.Settings.titulo)
		lblBuscar.ForeColor = System.Drawing.ColorTranslator.FromHtml(My.Settings.etiquetas)
		lblEtiquetas.ForeColor = System.Drawing.ColorTranslator.FromHtml(My.Settings.etiquetas)
