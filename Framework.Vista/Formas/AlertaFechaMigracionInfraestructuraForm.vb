...
Public Class AlertaFechaMigracionInfraestructuraForm
    Private Sub AlertaFechaMigracionInfraestructuraForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'obtenerImagen64Sql()
    End Sub
    ...
    '    dtImagen64 = objAlerta.obtenerAlertaMigracion(3)
    '    If dtImagen64.Rows.Count > 0 Then
    '        imagen = dtImagen64.Rows(0).Item(0).ToString
    '        pbAvisoDiasRestantesOtraFecha.SizeMode = PictureBoxSizeMode.Zoom
    '        pbAvisoDiasRestantesOtraFecha.Image = ConvertBase64ToImage(imagen)
    '    End If
    'End Sub
